...
int nCoinbaseMaturity = 9;  // Confirmed
...
const string strMessageMagic = "Ncoin Signed Message:\n";
...
int64_t GetProofOfStakeReward(const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if(nBestHeight >= 100 && nBestHeight < 10001){
      ...
      nSubsidy = 60 * COIN;
    } else if (nBestHeight >= 80001 && nBestHeight < 100001){
      nSubsidy = 80 * COIN;
    } else if (nBestHeight >= 100001 && nBestHeight < 125001){
      nSubsidy = 40 * COIN;
    } else if (nBestHeight >= 125001 && nBestHeight < 150001){
      nSubsidy = 30 * COIN;
    } else if (nBestHeight >= 150001){
      nSubsidy = 9 * COIN;
    } else {
      nSubsidy = 9 * COIN;
    }
...
static int64_t nTargetTimespan = 15 * 60;  // 30 mins
