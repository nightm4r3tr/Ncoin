...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizeNcoin = new QSpinBox(tabMain);
        anonymizeNcoin->setObjectName(QStringLiteral("anonymizeNcoin"));
        anonymizeNcoin->setMinimum(2);
        anonymizeNcoin->setMaximum(10000);
        anonymizeNcoin->setSingleStep(10);
        anonymizeNcoin->setValue(1000);

        gridLayout->addWidget(anonymizeNcoin, 7, 1, 1, 1);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start Ncoin after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start Ncoin on system login", 0));
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of Ncoin to keep anonymized", 0));
        tabWidget->setTabText(tabWidget->indexOf(tabMain), QApplication::translate("OptionsDialog", "&Main", 0));
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the Ncoin client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the Ncoin network through a SOCKS5 proxy (e.g. when connecting through Tor).", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting Ncoin.", 0));
#endif // QT_NO_TOOLTIP
