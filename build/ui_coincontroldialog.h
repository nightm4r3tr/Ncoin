...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 NCTL"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 NCTL"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 NCTL"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 NCTL"));
